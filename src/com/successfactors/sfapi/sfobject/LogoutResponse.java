...
public class LogoutResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the result value for this LogoutResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this LogoutResponse.
     * 
     * @param result
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", ">logoutResponse"));
