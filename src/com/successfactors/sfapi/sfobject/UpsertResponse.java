...
public class UpsertResponse  implements java.io.Serializable {
    private com.successfactors.sfapi.sfobject.UpsertResult result;

    public UpsertResponse() {
    }

    public UpsertResponse(
           com.successfactors.sfapi.sfobject.UpsertResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.successfactors.sfapi.sfobject.UpsertResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.successfactors.sfapi.sfobject.UpsertResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", ">upsertResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", "UpsertResult"));
