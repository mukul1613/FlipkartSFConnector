...
public class IsValidSessionResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the result value for this IsValidSessionResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this IsValidSessionResponse.
     * 
     * @param result
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", ">isValidSessionResponse"));
