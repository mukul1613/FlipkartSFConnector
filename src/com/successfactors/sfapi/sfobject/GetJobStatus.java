...
public class GetJobStatus  implements java.io.Serializable {
    ...
    /**
     * Gets the taskId value for this GetJobStatus.
     * 
     * @return taskId
     */
    ...
    /**
     * Sets the taskId value for this GetJobStatus.
     * 
     * @param taskId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", ">getJobStatus"));
