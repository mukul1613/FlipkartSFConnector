...
public class QueryMoreResponse  implements java.io.Serializable {
    private com.successfactors.sfapi.sfobject.QueryResult result;

    public QueryMoreResponse() {
    }

    public QueryMoreResponse(
           com.successfactors.sfapi.sfobject.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.successfactors.sfapi.sfobject.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.successfactors.sfapi.sfobject.QueryResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", ">queryMoreResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:sfobject.sfapi.successfactors.com", "QueryResult"));
